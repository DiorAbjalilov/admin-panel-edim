  ...
  return (
    <>
      ...
      <Form
        ...
        name="add-restaurant"
      >
        <Form.Item name="value" label="Адрес" required rules={[rules]}>
          <Select
            showSearch
        ...
        >
          {(fields, { add, remove }, { errors }) => (
            <>
              ...
              <Button onClick={() => add("")} style={{ marginBottom: 24 }}>
                Добавить еще номер
              </Button>
            </>
          )}
        ...
        <Form.Item name="allTime" valuePropName="checked">
          <Checkbox onChange={(e) => setAllTime(e.target.checked)}>
            Круглосуточно
          </Checkbox>
        </Form.Item>
