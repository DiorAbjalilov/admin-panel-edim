...
const Terms = () => {
    return (
        <Container>
            ...
            <p className='text'>
                Настоящее Пользовательское соглашение (далее – «Соглашение») заключается между ООО «Квадрат» и любым лицом, намеревающимся использовать и/или использующим приложение «ЕдаТут» для мобильных устройств под управлением iOS и Android
            </p>
            <p className='subtitle'>
                1. Термины и определения
            </p>
            <p className='text'>
                1.1 Администрация – ООО «Квадрат», адрес 677000, г. Якутск, 202-й микрорайон, 19.
            </p>
            <p className='text'>
                1.2 Сервис – приложение «ЕдаТут» для мобильных устройств под управлением iOS и Android. Правообладателем Сервиса в целом является Администрация, правообладателями отдельных компонентов Сервиса могут являться третьи лица, предоставившие Администрации право использовать соответствующие компоненты в составе Сервиса.
            </p>
            <p className='text'>
            ...
            <p className='text'>
                8.7. Сформированный заказ подлежит подтверждению либо отмене со стороны Партнера ЕдаТут в зависимости от его нагрузки в момент оформления заказа.
            </p>
            <p className='text'>
                8.8. ЕдаТут вправе отменить заказ в случае отсутствия в зоне доставке заказа лица, осуществляющего доставку.
            </p>
            <p className='text'>
                8.9. Уведомления о сроках доставки, предоставляемые Пользователю, носят информационный характер и могут не учитывать обстоятельства, не зависящие от воли ЕдаТут Партнера, лица, осуществляющего доставку, в том числе: задержки в связи с неблагоприятными метеоусловиями, дорожными заторами и пр. Также Пользователь подтверждает свое согласие с тем, что в период повышенного спроса (сезонного или вызванного распространением массовых промокодов) сроки подтверждения заказа и его доставки могут быть увеличены.
            </p>
            <p className='text'>
            ...
            <p className='text'>
                8.11. ЕдаТут оставляет за собой право отказать Пользователю в применении сервиса ЕдаТут без уведомления Пользователя и/или без объяснения причин.
            </p>
            <p className='subtitle'>
                9. Оплата заказа
            </p>
            ...
            <p className='text'>
                9.1.1. непосредственно при получении заказа наличными денежными средствами, банковской картой или иными способами, предоставленными Партнером ЕдаТут (если применимо).
            </p>
            <p className='text'>
                9.1.2. онлайн-оплата (безналичная оплата) в приложении ЕдаТут банковской картой VISA/MasterCard через платежную систему Акционерного общества сервиса «Тинькофф Банк». Все дополнительные расходы по перечислению денежных средств за заказ несёт Пользователь.
            </p>
            <p className='text'>
                9.1.3. онлайн-оплата (безналичная оплата) в приложении ЕдаТут банковской картой VISA/MasterCard через платежную систему Акционерного общества сервиса «Тинькофф Банк». Все дополнительные расходы по перечислению денежных средств за заказ несёт Пользователь. Данные платежных карт хранятся на стороне эквайера с соблюдением требований стандартов.
            </p>
            <p className='text'>
            ...
            <p className='text'>
                9.4. Во избежание случаев мошенничества при оплате банковскими картами платежи, оплаченные банковской картой, могут проверяться ЕдаТут в рамках имеющихся возможностей. Пользователь, оформивший такой платеж, обязан по запросу, поступившему от ЕдаТут, предоставить копию необходимых документов для подтверждения правомерного использования банковской карты.
            </p>
            <p className='text'>
                9.5. Возврат денежных средств, оплаченных Пользователем через платежную систему на Сайте банковской картой, осуществляется только на ту карту, с которой была произведена оплата, в соответствии с правилами международных платежных систем и действующим законодательством РФ о национальной платежной системе. Сроки возврата денежных средств регулируются банками-эмитентами и не зависят от сервиса ЕдаТут.
            </p>
            <p className='text'>
                9.6. При использовании Пользователем безналичного способа оплаты кассовый чек направляется Пользователю на подтвержденный номер мобильного телефона, указанный Пользователем при регистрации в Приложении, с помощью push-уведомления приложения ЕдаТут, и доступен Пользователю при открытии такого уведомления, при условии, что Пользователь не отключил возможность получения push-уведомлений для приложения ЕдаТут. Кассовый чек также доступен Пользователю после совершения заказа в разделе «Мои заказы» на Сайте и в приложении. В случае, если Пользователь имеет трудности с ознакомлением с кассовым чеком, Пользователь вправе обратиться в контакт-центр.
            </p>
            <p className='subtitle'>
                10. Отмена и возврат
            </p>
            <p className='text'>
                10.1. Пользователь вправе отказаться от ожидания заказа в случае, если к указанному моменту самовывоза заказ не был готов, после 60 минут срока заказа. В этом случае ЕдаТут возвращает денежные средства Пользователю, при этом срок возврата денежных средств зависит от банка-эмитента.
            </p>
            <p className='text'>
            ...
            <p className='text'>
                10.3. Важно: Отмена заказа Пользователем возможна только до момента получения подтверждения о принятии заказа либо при обращении в контактный центр ЕдаТут в том случае, если ресторан не начал приготовление заказа. В случае предзаказа заказ нельзя отменить за 30 минут до момента его самовывоза.
            </p>
            <p className='text'>
            ...
            <p className='text'>
                11.4 обработка операций проводится на стороне процессингового центра/банка, сервис ЕдаТут не хранит карточные данные.
            </p>
        </Container>
    )
}
